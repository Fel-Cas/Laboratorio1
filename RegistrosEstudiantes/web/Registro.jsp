...
<html>
    ...
    <body>
        ...
        <h1>Registrate</h1>
        <div align="center">
            <form action="EstudiantesServlet?action=registro" method="post" onsubmit="return validacion()" enctype="multipart/form-data" >
                <table>
                    <tr>
                    ...
                    <tr>
                        <th><label><b>Foto Estudiante</b></label></th>
                        <th>
                            <input type="file"  class="form-control" name="archivo_imagen" id="archivo_imagen" accept="image/*" />
                        </th>
                    </tr>
                    <tr>
